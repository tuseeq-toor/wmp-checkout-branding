...
${errorInfo.componentStack}`);
  ...
  function useShippingOptionTarget() {
    const api = useApi();
    if (!api.target || api.isTargetSelected === void 0) {
    ...
    const shippingOption = (0, import_react11.useMemo)(() => {
      return {
  ...
  // extensions/shipping-method-delivery-date/src/Checkout.tsx
...
//# sourceMappingURL=shipping-method-delivery-date.js.map
